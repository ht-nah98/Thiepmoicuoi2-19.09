...
export const offline = (() => {
    ...
    const setOffline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-ban me-2"></i>Mất kết nối mạng';
    };
    ...
    const setOnline = () => {
        ...
        el.firstElementChild.innerHTML = '<i class="fa-solid fa-cloud me-2"></i>Đã có mạng trở lại';
    };
