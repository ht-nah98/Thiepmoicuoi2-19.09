...
export const image = (() => {
    ...
    const init = () => {
        ...
        // Bỏ qua khung ảnh phóng to (#show-modal-image) — nó chỉ là chỗ chứa,
        // không có data-src nên không bao giờ tải xong, khiến tiến trình kẹt.
        images = document.querySelectorAll('img:not(#show-modal-image)');
